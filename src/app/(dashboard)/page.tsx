...
const riskHeatMapData = [
  { level: "Critical", count: 4, fill: "#ef4444" },
  { level: "High", count: 12, fill: "#f97316" },
  { level: "Medium", count: 28, fill: "#facc15" },
  { level: "Low", count: 45, fill: "#10b981" },
]
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="border-l-4 border-l-accent">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              Next: Internal ISO Audit (12 days)
            </p>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-7">
        <Card className="lg:col-span-4">
          <CardHeader>
            ...
            <CardDescription>
              Score breakdown across key international standards.
            </CardDescription>
          </CardHeader>
